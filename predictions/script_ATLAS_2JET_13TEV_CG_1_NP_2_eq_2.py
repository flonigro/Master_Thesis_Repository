...
def create_shell_script(base_path):
    ...
    for table_number in range(7, 13):  # Loop from 7 to 12 for Table7 to Table12
        table_dir = os.path.join("/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_13TEV_SCRIPTS_CG_1_NP_2_eq_2", f"Table{table_number}")
...
def main():
    ...
    for yaml_file in yaml_files:
        ...
        if table_number in tables:
            ...
            path_to_script = os.path.join('/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_13TEV_SCRIPTS_CG_1_NP_2_eq_2', f'Table{table_number}')
