...
from misc_utils_13TeV_ATLAS_dijet import (modify_value_in_file, print_to_file)
import logging

log = logging.getLogger(__name__)

# Assuming read_HEP_data_to_mg5 is imported or defined somewhere above
from hepdata_parser_13TEV_ATLAS_DIJET_R04 import read_HEP_data_to_mg5
...
def generate_mjj_launch_cards(mjj_bins, base_path, ystarmin, ystarmax):
    ...
    for mjj_bin in mjj_bins:
        ...
        f"output ATLAS_DIJET_13TEV_R04_Y_{ystarmin}_{ystarmax}_mjj_{mjj_bin['low']}_{mjj_bin['high']}\n"
        "launch\n"
        f"set run_tag ATLAS_DIJET_13TEV_R04_Y_{ystarmin}_{ystarmax}_mjj_{mjj_bin['low']}_{mjj_bin['high']}\n"
        "set nevents 10000\n"
        "set cG 1.0\n"
        "set cG1 0.0\n"
        "set cG2 0.0\n"
...
def create_shell_script(base_path):
    ...
    for table_number in range(7, 13):  # Loop from 7 to 12 for Table7 to Table12
        table_dir = os.path.join("/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_13TEV_SCRIPTS_CG_1_NP_2_eq_4", f"Table{table_number}")
...
def main():
    yaml_files_directory = "/home/turing/MG5_aMC_v3_4_2/dijet/data/rawdata/ATLAS_2JET_13TEV_rawdata/"
    ...
    for yaml_file in yaml_files:
        ...
        if table_number in tables:
            ...
            path_to_script = os.path.join('/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_13TEV_SCRIPTS_CG_1_NP_2_eq_4', f'Table{table_number}')
