...
output_base_dir = '/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_7TEV_SCRIPTS_CG_1_NP_2_eq_2/'
            ...
            if value_key is not None:
                ...
                for error in value.get('errors', []):
                    if 'symerror' in error:
                        ...
                        errors_by_value[value_key].extend([float(error['asymerror']['minus'].rstrip('%')), float(error['asymerror']['plus'].rstrip('%'))])
...
def write_errors_and_variances_to_csv(errors_by_value, table_number):
    ...
    errors_output_file_path = f"/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_7TEV_SCRIPTS_CG_1_NP_2_eq_2/{table_number}/errNew_file.csv"
    variance_output_file_path = f"/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_7TEV_SCRIPTS_CG_1_NP_2_eq_2/{table_number}/varianceNewTable{table_number}.csv"
