...
directory = '/home/turing/MG5_aMC_v3_4_2/dijet/data/rawdata/ATLAS_2JET_13TEV_rawdata/'
labels = ["0.0<y*<0.5", "0.5<y*<1.0", "1.0<y*<1.5", "1.5<y*<2.0", "2.0<y*<2.5", "2.5<y*<3.0"]
output_base_dir = '/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_13TEV_SCRIPTS_CG_1_NP_2_eq_2/'
            ...
            if value_key is not None:
                ...
                for error in value.get('errors', []):
                    if 'symerror' in error:
                        ...
                        errors_by_value[value_key].extend([float(error['asymerror']['minus']), float(error['asymerror']['plus'])])
...
def write_errors_and_variances_to_csv(errors_by_value, table_number):
    ...
    errors_output_file_path = f"/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_13TEV_SCRIPTS_CG_1_NP_2_eq_2/{table_number}/errNew_file.csv"
    variance_output_file_path = f"/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_13TEV_SCRIPTS_CG_1_NP_2_eq_2/{table_number}/varianceNewTable{table_number}.csv"
...
def main():
    for table_number in range(7, 13):
        ...
        file_path_yaml = os.path.join(directory, f'HEPData-ins1634970-v1-Table_{table_number}.yaml')
