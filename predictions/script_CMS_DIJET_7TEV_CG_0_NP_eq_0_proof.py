...
def create_shell_script(base_path):
    ...
    for table_number in range(6, 11):  # Loop from 7 to 12 for Table7 to Table12
        table_dir = os.path.join("/home/turing/MG5_aMC_v3_4_2/CMS_DIJET_7TEV_SCRIPTS_CG_0_NP_eq_0", f"Table{table_number}")
...
def main():
    ...
    for yaml_file in yaml_files:
        ...
        if table_number in tables:
            ...
            path_to_script = os.path.join('/home/turing/MG5_aMC_v3_4_2/CMS_DIJET_7TEV_SCRIPTS_CG_0_NP_eq_0', f'Table{table_number}')
