...
def main():
    ...
    for table in tables:
        df_sm = f"/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_13TEV_SCRIPTS_CG_0_NP_eq_0/Table{table}/cross_section_output.csv"
        df_smeft =f"/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_13TEV_SCRIPTS_CG_1_NP_2_eq_2/Table{table}/cross_section_output.csv"
...
********************************************************************************************"""
        ...
        k_factors_df = k_factors( f"/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_13TEV_SCRIPTS_CG_1_NP_2_eq_2/Table{table}/", df_sm, df_smeft)
        clean_k_factors_df = remove_header_from_csv(f"/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_13TEV_SCRIPTS_CG_1_NP_2_eq_2/Table{table}/k_factors.csv", f"/home/turing/MG5_aMC_v3_4_2/ATLAS_DIJET_13TEV_SCRIPTS_CG_1_NP_2_eq_2/Table{table}/clean_k_factors.csv")
    ...
    with open(os.path.join(f"/home/turing/MG5_aMC_v3_4_2/K_FACTORS_ATLAS_DIJET_13TEV_NP_EQ_0_NP_2_EQ_2/all_k_factors.txt"), "w") as outfile:
